...
class SwTimer extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.shadowRoot.getElementById('treble').onclick = () => this.dispatchEvent(new CustomEvent("sw-timer", { bubbles: true, composed: true, detail: { clef: 'treble' }}));
        this.shadowRoot.getElementById('bass').onclick = () => this.dispatchEvent(new CustomEvent("sw-timer", { bubbles: true, composed: true, detail: { clef: 'bass' }}));
    }
